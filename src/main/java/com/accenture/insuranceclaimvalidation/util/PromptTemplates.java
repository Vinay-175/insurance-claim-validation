...
public final class PromptTemplates {
    ...
    public static String buildClaimExtractionPrompt(String extractedText) {
        ...
        return """
                ...
                15. If multiple diagnoses exist,

                use the first as diagnosis

                and remaining as secondaryDiagnosis.

                16. If multiple procedures exist,

                combine them into one comma separated string.
    ...
    public static String buildRecommendationPrompt(
        ...
        return """
                ...
                Your responsibility is to determine whether the submitted claim should be APPROVED,
                sent for MANUAL_REVIEW,
                or REJECTED.

                Your objective is NOT to reject claims.

                Your objective is to fairly determine whether the complete claim appears medically,
                financially and administratively legitimate.
                ...
                When uncertain,
                prefer MANUAL_REVIEW instead of REJECTED.
                ...
                If the claim amount falls inside a realistic range,

                do NOT consider it suspicious.

                If the amount is LOWER than expected,
                ...
                Never recommend MANUAL_REVIEW solely because
                the amount is lower than expected.

                A LOW claim amount alone
                is NOT suspicious.

                If the claim amount is substantially HIGHER
                than a realistic range
                without medical justification,

                treat this as a strong fraud indicator.
